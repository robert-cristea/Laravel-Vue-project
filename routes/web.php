...
Route::get('/users', 'UsersController@lister');
...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function () {
    ...
    Route::get('/dashboard/basic', ['as' => 'admin.dashboard.basic', 'uses' => 'DashboardController@basic']);
    Route::get('/dashboard/ecommerce', ['as' => 'admin.dashboard.ecommerce', 'uses' => 'DashboardController@ecommerce']);
    Route::get('/dashboard/finance', ['as' => 'admin.dashboard.finance', 'uses' => 'DashboardController@finance']);

    Route::resource('projects', 'ProjectController');
    Route::get('get-auditors','ProjectController@getAuditor')->name('getAuditors');
    Route::post('assessment-status','ProjectController@assessmentStatus')->name('assessmentStatus');

    Route::resource('concessionaires', 'ConcessionaireController');
    Route::get('admins/adcreate', 'AdminController@adCreate')->name('admins.adcreate');
    Route::get('admins/adsearch', 'AdminController@adSearch')->name('admins.adsearch');
    Route::get('auditors/adcreate', 'AuditorController@adCreate')->name('auditors.adcreate');
    Route::get('auditors/adsearch', 'AuditorController@adSearch')->name('auditors.adsearch');
    Route::resource('auditors', 'AuditorController');
    Route::resource('admins', 'AdminController');
    

    Route::post('image-upload', 'ImageUploadController@imageUploadPost')->name('image.upload.post');
    Route::post('pdf-upload', 'PdfUploadController@pdfUploadPost')->name('pdf.upload.post');
    Route::post('pdf-upload-work-program', 'PdfUploadController@pdfUploadWorkProgram')->name('pdf.upload_work_program.post');

    Route::get('delete-assessment-year', 'ProjectController@deleteAssessmentYear')->name('project.assessment_year.delete');

    Route::post('note', 'NoteController@post')->name('note.post');
    Route::delete('note/{id}', 'NoteController@delete')->name('note.delete');

    Route::post('emission_factor', 'EmissionFactorController@post')->name('emission_factor.post');
    Route::delete('emission_factor/{id}', 'EmissionFactorController@delete')->name('emission_factor.delete');

    Route::resource('settings/keywords', 'KeywordController');
    Route::resource('settings/constants', 'ConstantController');
    Route::resource('settings/highwaylist', 'HighwaylistController');
    Route::post('highwaylist', "HighwaylistController@saveList");
    Route::post('highway-edit','HighwaylistController@editHighway')->name('highway-edit');
