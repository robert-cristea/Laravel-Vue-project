...
<html lang="en">
    <head>
        ...
        <title>Sistem CFC : Penilaian Projek</title>
    </head>
    <body>
        <table>
            <tr>
            ...
            <tr>
                <td>Status: Konsesi telah menghantar satu penilaian projek untuk dinilai</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>Tuan boleh log masuk ke sistem CFC untuk mula membuat penilaian</td>
            </tr>
            <tr>
