...
@section('scripts')
    <script src="/assets/admin/js/pages/auditors.js"></script>
@stop
@section('styles')
    <style>
    ...
    <div class="main-content contact-page">
        ...
        <div class="row contact-box">
            <div class="contact-list">
                <div class="float-right" style="margin-bottom:10px;margin-right:10px;"><a style="background-color:#4fc47f;" type="button" href="/admin/auditor" onclick="" class="btn btn-primary">Create New Assessor</a></div>
                <table id="contact-datatable" class="table table-sm table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-success btn-xs" href="/admin/auditor/<?php echo $con->id; ?>"><i class="icon-fa icon-fa-user"></i> Edit
                            </a>
                            <a class="btn btn-danger btn-xs" href="/admin/delete-auditor/<?php echo $con->id ?>" onclick="return confirm('Are you sure to delete?')"><i class="icon-fa icon-fa-trash"></i> Delete
                            </a>
                        </td>
                    </tr>
                    <?php
