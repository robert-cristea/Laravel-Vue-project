            ...
            <div class="col-12">
                <table class="table table-sm form-group w-100">
                    ...
                    <tr>
                        ...
                        <td><input type="text" :value="totalDistance" class="form-control" disabled></td>
                        <td><input type="text" :value="totalSecondValue" class="form-control" disabled></td>
                        <td><input type="text" :value="totalKm" class="form-control" disabled></td>
                        <td>{{ subTotalCarbonEmission }}</td>
                        <td style="text-align: right">t CO2-eq/km</td>
                    </tr>
                    <tr>
                        <td colspan=5>
  ...
  export default {
    ...
    methods: {
      ...
      getRowCarbonEmission(i) {
        ...
        var truckConstant = 0.35 // value in 5 MC 4.2.2, Keywords.D24, hardcoded
        var machineryEmissionFactor = 0.00268 // value in 5 MC 4.2.2, Keywords.C17, hardcoded
